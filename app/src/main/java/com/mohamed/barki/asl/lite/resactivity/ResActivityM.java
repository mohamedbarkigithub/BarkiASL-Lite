...
public class ResActivityM extends Activity
{
	public static String[][] resList = new String[][]{
			...
			{"m4", "10X8J5eEhr9oiQEgYVquO456KiAOfHRmh", "russie", "روسيا"},
			{"m5", "110ZYC87IpBoinva3zjWoroHAYaJCToEk", "côte", "ساحل"},
			{"m6", "11UOjSD3ku02cwO5w1IAF6IPMhXFjAvud", "turquie", "تركيا"},
			...
			{"m12", "19Zq_Op6nbZMwvUeaSoWtf-EGhiVbsqi7", "brésil", "البرازيل"},
			...
			{"m26", "1iHU5Rm-rQh6X2kSpyWN55PixgKW_SVs-", "australie", "أستراليا"},
			{"m27", "10F0WSXrGOnSa1A8MtLbKoAwiZZEpCXGn", "algérie", "الجزائر"},
			...
			{"m33", "1028CXDXUZSGeslUMmLVrwPkJZu4G7Ooo", "chine", "الصين"},
			...
			{"m42", "10e8ZvqLCgZdn8u-0TH7MsDMbXfynIU3F", "canada", "كندا"},
			...
			{"m51", "115DmJPmJ-_s9h-bOjEQGQvBMC5HYFGdY", "mexique", "المكسيك"},
			...
			{"m54", "11GTDoVpoVPh6HitRkLicZInK5F6YnAzd", "états-unis d'amérique", "الولايات المتحدة الأمريكية"},
			...
			{"m59", "11MvD40-TWbBwsddPhL6UJ2ofAUBe20Np", "jabon", "اليابان"},
